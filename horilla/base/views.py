...
@login_required
@permission_required("base.view_employeeshift")
def shift_schedule_template_view(request):
    """
    This method is used to display the shift schedule template
    """
    return render(request, "base/shift_schedule_template.html")
